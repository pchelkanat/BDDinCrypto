...
import PBL.PyBool_builder as PBB

from PBL import PyBool_algorithms as PBA
...
def parse_dimacs(fname):
    ...
    from PBL.PyBool_dimacs_parse import parse_file as parse_dimacs_file
...
def parse_std(fname):
    ...
    """
    from PBL.PyBool_std_parse import parse_file as parse_std_file
